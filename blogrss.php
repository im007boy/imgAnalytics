...
**/
  ...
  function trackPageView() {
    ...
    //Modified by im007boy@gmail.com
    ...
    // remove http://
	$documentPath = substr($documentReferer,strpos($documentReferer,'://')+3);
    
    $domainName = substr($documentPath,0,strpos($documentPath,'/'));
    if (empty($domainName)) {
      $domainName = "";
    }
    
	$documentPath = substr($documentPath,strlen($domainName));
